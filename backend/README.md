...
## Project Structure
    ...
    ├── testapiautosetting_127296  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_127296`
...
2. Clone this repo and `cd testapiautosetting_127296`
